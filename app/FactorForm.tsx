...
import { FIELD_TYPES, IncomeFactory } from '@/business/factorys/IncomeFactory'
...
export default function FactorForm({
  ...
  const saveFactor = (e: FormEvent) => {
    ...
    dispatch(addFactor(factory.buildFactor(formJson)))
    onFinished()
  }
